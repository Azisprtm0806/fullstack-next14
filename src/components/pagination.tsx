...
const Pagination = ({ totalPages }: { totalPages: number }) => {
  ...
  const PaginationNumber = ({
    ...
    const className = clsx(
      "flex h-10 w-10 items-center justiy-center text-center text-sm border",
      {
        "rounded-l-sm": position === "first" || position === "middle",
  ...
  const PaginationArrow = ({
    ...
    const className = clsx(
      "flex h-10 w-10 items-center justiy-center  text-sm border",
      {
